...
int handleFrame(cv::Mat& frame, const bool receivedInitialTouch, const bool requiresInit);
...
//const string VIDEO_FILENAME = "assets/hand_test_black_chair_background7.mp4";
//const string VIDEO_FILENAME = "assets/hand_test_white_background.mp4";
